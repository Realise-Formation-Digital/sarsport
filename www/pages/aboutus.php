...
<head>
  ...
  <title>Sarsports - Qui sommes-nous ?</title>
            ...
            <div class="navbar-bottom-menu">
              ...
              <div class="navbar-collapse justify-content-center collapse" id="navbarSupportedContent_adrian">
                ...
                <ul class="navbar-nav d-lg-flex justify-content-between align-items-center">
                  ...
                  <li class="nav-item">
                    <a class="nav-link blanc" href="football.html">Football</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link blanc" href="hockey.html">Hockey</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link blanc" href="tennis.html">Tennis</a>
                  </li>
                  <li class="nav-item active">
                    <a class="nav-link active blanc" href="aboutus.html">Qui sommes nous ?</a>
                  </li>
                  <!--LOGIN-->
                  <li class="nav-item">
          ...
          <div class="col-lg-6  mb-5 mb-sm-2">
            ...
            <div class="row">
              <div class="col-sm-12  mb-5 mb-sm-2">
                ...
                <p>
                  Créé en 2020, Sarsport est composé de 5 jounalistes et touchent plus de 548'000 lecteurs en Suisse et
                  dans le monde.
                  Grâce à ce nombre de lecteurs, Sarsport a ouvert un bureau à Lausanne. Deux journalistes sont donc
                  présents dans la capitale
                  Olympique pour couvrir les points forts de l’actualité sportive. Des interviews, des reportages, des
                  brèves et des éclairages
                  sont réalisés régulièrement et publiés sur le site Sarsport.</p>
                <p>Sarsport attachent aussi une grande importance aux événements sportifs nationaux et internationaux.
                  Il
                  peut suivre, en envoyant un journaliste sur place,
                  les différents championnats nationaux de football et hockey ainsi que le Tennis comme Roland Garros,
                  Wimbledon, etc.</p>
              </div>
            </div>
